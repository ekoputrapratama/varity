...
enum _VaritySliderType { material, adaptive }
...
class VaritySlider extends StatefulWidget {
  ...
  })  : _sliderType = _VaritySliderType.material,
        assert(value != null),
        assert(min != null),
        assert(max != null),
        assert(min <= max),
  ...
  const VaritySlider.adaptive({
    ...
    this.focusNode,
    this.autofocus = false,
  })  : _sliderType = _VaritySliderType.adaptive,
        assert(value != null),
        assert(min != null),
        assert(max != null),
        assert(min <= max),
  ...
  final _VaritySliderType _sliderType;

  @override
  _VaritySliderState createState() => _VaritySliderState();
...
class _VaritySliderState extends State<VaritySlider>
  ...
  void _handleTouchStart(double value) {
    assert(widget.onTouchStart != null);
    widget.onTouchStart!(_lerp(value));
  }

  void _handleTouchEnd(double value) {
    assert(widget.onTouchEnd != null);
    widget.onTouchEnd!(_lerp(value));
  }
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget._sliderType) {
      case _VaritySliderType.material:
        return _buildMaterialSlider(context);

      case _VaritySliderType.adaptive:
        {
      ...
      child: FocusableActionDetector(
        ...
        child: CompositedTransformTarget(
          ...
          child: _SliderRenderObjectWidget(
            ...
            onTouchStart:
                widget.onTouchStart != null ? _handleTouchStart : null,
            onTouchEnd: widget.onTouchEnd != null ? _handleTouchEnd : null,
            state: this,
...
class _SliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  final ValueChanged<double>? onTouchEnd;
  final SemanticFormatterCallback? semanticFormatterCallback;
  final _VaritySliderState state;
  final bool hasFocus;
  final bool hovering;
  ...
  void updateRenderObject(BuildContext context, _RenderSlider renderObject) {
    ...
    // the _SliderRenderObjectWidget object and the _VaritySliderState object.
  }
}
...
class _RenderSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  _RenderSlider({
    ...
    required this.onTouchStart,
    required this.onTouchEnd,
    required _VaritySliderState state,
  ...
  final _VaritySliderState _state;
  ...
  ValueChanged<double>? onTouchStart;
  ValueChanged<double>? onTouchEnd;
  ...
  void _handleDragEnd(DragEndDetails details) {
    if (onTouchEnd != null) {
      onTouchEnd!(_discretize(_currentDragValue));
    }
    _endInteraction();
  }
  ...
  void _handleTapDown(TapDownDetails details) {
    if (onTouchStart != null) {
      onTouchStart!(_discretize(_currentDragValue));
    }
    _startInteraction(details.globalPosition);
  }
