...
abstract class VarityAccessibilityService extends AndroidNativeObject
    with ContextMixin {
  ...
  static Map<int, VarityAccessibilityService> _serviceRegistry = Map();
  ...
  static Future<int> registerService(
      VarityAccessibilityService serviceHandler) async {
  ...
  static void unregisterService(VarityAccessibilityService service) {
