...
object Ln {
  ...
  private val TAG = "com.mixaline.varity"
  private val PREFIX = "[varity] "
...
//      println(PREFIX + "DEBUG: " + msg.toString())
  ...
  fun e(vararg params: Any?) {
    ...
    if (isEnabled(Level.ERROR)) {
      ...
      } else if (params.size == 1 && params[0] is String) {
        msg = params[0]
      } else if (params.size == 1 && params[0] is Throwable) {
        throwable = params[0] as Throwable
      }
